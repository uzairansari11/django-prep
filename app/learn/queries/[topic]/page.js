      ...
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-8">
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm">
            The topic <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 font-mono text-xs">{topicId}</code> does not exist in our QuerySet curriculum.
          </p>
          <Link
            href="/learn/queries"
